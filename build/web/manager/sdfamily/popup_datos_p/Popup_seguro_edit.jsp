...
<html:form target="_self" action="/DatosPer/Popup/add_seguro.do">
	<html:hidden property="segm_mails_enviados" />
	<html:hidden property="segm_ultimo_mail" />
	<html:hidden property="segm_cod" />
	<html:hidden property="segm_usuf_cod" />
