					...
					<table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<tr>
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								...
								<tr>
									<td class="tdOverNameOption" colspan="3"><bean:message key="global.button.adicionar" />&nbsp;<bean:message key="845" /></td>
								</tr>
								...
								<tr>
									...
									<table border="0" id="tab2" cellspacing="0" cellpadding="0" width="100%">
										...
										<tr>
											...
											<td><html:text property="elab_fecha1" maxlength="10" size="10" styleClass="sel" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><html:text property="elab_fecha2" maxlength="10" size="10" styleClass="sel" /></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><html:text property="elab_fecha3" maxlength="10" size="10" styleClass="sel" /></td>
										</tr>
										<tr>
								...
								<tr>
									...
									<table height="30" cellpadding="0" cellspacing="0" border="0" width="100%">
										...
										<tr align="center" valign="middle">
											<td><INPUT type="button" onclick="enviar('<%=request.getAttribute("num_control")%>')" class="sbttn" value="<bean:message key="global.button.aceptar"/>"></td>
										</tr>
										<tr>
											<td>
