...
function actualizar(){
	...
	document.forms[0].action='<%=request.getContextPath()%>/Control_Otro/Popup/edit_controlconcita.do?change=1';
										...
										<tr>
											<td>
												<table cellpadding="0" cellspacing="0" border="0" width="100%">
													...
													<tr>
													<td class="view_item"><bean:message key="7273" />
													</td>
													</tr>
													<tr>
															<TD>&nbsp;
															...
															<table border="0" id="tab2" cellspacing="0" cellpadding="0" width="100%">
																...
																<tr>
																	...
																	<td>
																		...
																		<script>obtenerCamposFecha('cDia1', 'cMes1', 'cAno1', 'cootc_fecha');</script>
																	</td>
																</tr>
																<tr>
																	<TD class="view_item">
