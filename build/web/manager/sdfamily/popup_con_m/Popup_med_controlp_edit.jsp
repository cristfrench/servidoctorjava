...
function enviar()
{
	...
	convertirACampoHora('hora','minuto','ampm','cmed_hora');
	document.forms[0].action="<%=request.getContextPath()%>/Control_Medico/Popup/transferir_controlP.do"
...
<html:form target="_self" action="/Control_Medico/Popup/transferir_controlP.do">
													...
													<table border="0" id="tab2" cellspacing="0" cellpadding="0" width="100%">
														...
														<tr>
															...
															<td>
																...
																<script>obtenerCamposFechaFuturo('cDia1', 'cMes1', 'cAno1', 'cmed_feccontrol', 10);</script>
															</td>
														</tr>
														<tr>
															<TD class="view_item">
															...
															<td class='view_item'>
																<html:hidden property="cmed_hora" styleId="cmed_hora" />
																<SCRIPT language="JavaScript">
											    					CamposHora('hora','minuto','ampm','cmed_hora');							    											    					
											    				</SCRIPT>
															</td>
														</tr>
														<tr>
