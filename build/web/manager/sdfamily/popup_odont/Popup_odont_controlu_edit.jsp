...
function enviar()
{
	if(document.forms[0].codo_destratamiento.value==''){
         ...
         document.forms[0].codo_destratamiento.focus();
         return false;
    }
	convertirACampo('cDia1', 'cMes1', 'cAno1', 'codo_feccontrol'); 
	document.forms[0].action="<%=request.getContextPath()%>/Control_Odont/Popup/transferir_controlU.do"
...
<html:form target="_self" action="/Control_Odont/Popup/transferir_controlU.do">
													...
													<table border="0" id="tab2" cellspacing="0" cellpadding="0" width="100%">
														...
														<tr>
															...
															<td>
																...
																<script>obtenerCamposFecha('cDia1', 'cMes1', 'cAno1', 'codo_feccontrol');</script>
															</td>
														</tr>
														<tr>
