...
function actualizar() {	
	document.forms[0].action='<%=request.getContextPath()%>/Histo_Medica/Popup/edit_enfermedad.do?change=1'
	document.forms[0].submit();	
}

</SCRIPT>

<html:form target="_self" action="/Histo_Medica/Popup/transferir_enfermedad.do">
	<html:hidden property="enfu_cod" />
	<html:hidden property="enfu_usuf_cod" />
	<input type="hidden" name="num_enf" value="<%=request.getParameter( "num_enf" )%>" />
												...
												<td colspan="3">
													...
													<table border="0" id="tab2" cellspacing="0" cellpadding="0" width="100%">
														...
														<tr>
															...
															<td>
																<html:text property="enfu_des" maxlength="40" size="50" styleClass="sel" />
															</td>
														</tr>
														<tr>
															<TD class="view_item">
