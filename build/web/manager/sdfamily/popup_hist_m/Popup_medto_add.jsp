					...
					<table align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
						...
						<tr>
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								...
								<tr>
									<td class="tdNameOption" colspan="3"><bean:message key="global.button.adicionar" />&nbsp;<bean:message key="3802" /></td>
								</tr>
								...
								<tr>
									...
									<table border="0" id="tab2" cellspacing="0" cellpadding="0" width="100%">
										...
										<tr>
											<TD colspan="3" class="view_item">&nbsp;<P ALIGN ="JUSTIFY"><bean:message key="7218" arg0="<%=res.getMessage("parametro_adicion_medicamento") %>"/></P></TD>
										</tr>
										<tr>
											<TD colspan="3">&nbsp;</TD>
										</tr>
