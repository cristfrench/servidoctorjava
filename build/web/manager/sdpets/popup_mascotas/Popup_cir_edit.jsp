...
<html:form target="_self" action="/DatosMascota/Popup/edit_cir_pets.do">
	<html:hidden property="cirp_cod" />
	<html:hidden property="cirp_mas_cod" />
	<input type="hidden" name="num_cir_pets" value="<%=request.getParameter( "num_cir_pets" )%>" />
												...
												<td colspan="3">
													...
													<table border="0" id="tab2" cellspacing="0" cellpadding="0" width="100%">
														...
														<tr>
															...
															<td class="view_item">
																<html:text property="cirp_des" maxlength="80" size="40" styleClass="sel" />
															</td>
														</tr>
														<tr>
															<TD class="view_item">
