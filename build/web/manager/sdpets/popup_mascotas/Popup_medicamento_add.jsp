					...
					<TABLE align="center" cellpadding="0" cellspacing="0" border="0" width="100%">
						<TR>
							...
							<TABLE cellpadding="0" cellspacing="0" border="0" width="100%">
								...
								<TR>
									<TD class="tdOverNameOption" colspan="3"><bean:message key="global.button.adicionar" />&nbsp;<bean:message key="1513" /></TD>
								</TR>
								<TR>
									<TD colspan="2" class="tdNameOption2"><bean:message key="58"/>&nbsp;<%=session.getAttribute("VACUNASCUIDADOS") != null && ((List)session.getAttribute("MASCOTAMEDICAMENTOS")).size() > 0 ? ((List)session.getAttribute("MASCOTAMEDICAMENTOS")).size() + 1 : 1%></TD>
								</TR>
								<TR>
									<TD colspan="2">&nbsp;</TD>
								</TR>
								<TR>
									<TD colspan="2" class="view_item"><bean:message key="7313"/>&nbsp;</TD>
								</TR>
								<TR>
									<TD colspan="3">
