...
<body >
<html:form target="_self" action="/DatosMascota/Popup/edit_vacuna.do">
<BR><BR>
	<TABLE border="0" cellpadding="0" cellspacing="0" align="center" width="98%">
	<html:hidden property="vcui_mas_cod"/>
	<html:hidden property="vcui_cod"/>
	<input type="hidden" name="num_vacuna" value="<%=request.getParameter("num_vacuna")%>"/>
		...
		<TR>
			...
			<TABLE class="tablag" border="0" id="tab2" cellspacing="0" cellpadding="0" width="100%">
				...
				<TR>
					<TD colspan="3" class="tdNameOption2"><bean:message key="138" />&nbsp;<bean:message key="1505" />&nbsp;O&nbsp;<bean:message key="1509" />&nbsp;Nº&nbsp;<%=Integer.parseInt(request.getParameter("num_vacuna"))+1%></TD>					
				</TR>
				<TR>
					<TD colspan="3" class="view_item">&nbsp;</TD>
				</TR>
				<TR>
