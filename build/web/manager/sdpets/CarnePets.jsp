...
<%@ page import="com.servidoctor.sdpets.model.MascotaCompleto"%>
<SCRIPT>
...
<html:form action="/CarnePets/generar.do" target="_self">
                              ...
                              <td>
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                  ...
                                  <tr>
                                    ...
                                    <td class="view_desc">
                                      <bean:write name="usuarioPetsForm" property="usup_usuario" />
                                    </td>
                                    <td></td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td colspan="3">
                                      <strong><bean:message key="4014" arg0="<%=request.getContextPath()%>" /></strong><br/><br/><img src="<%=request.getContextPath()%>/manager/sdpets/carne_<%=session.getAttribute("idioma")%>.jpg" border="0"><br>
                                    </td>
                                  </tr>
                                  <tr>                                  
                                    <td colspan="3">
  ...
  <script>tab_charge('carne','pets');</script>
</html:form>
