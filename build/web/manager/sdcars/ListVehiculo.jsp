						...
						<TABLE cellpadding="0" cellspacing="0" border="0" width="100%">
							...
							<tr>
							  <td colspan="4"><hr></td>
								...
								<tr>
									<td colspan="5" class="view_item" align="justify"><bean:message key="7400" /></td>
								</tr>
								<tr>
...
%>
									...
									<logic:iterate indexId="ind" id="vehiculo" name="VEHICULOS" type="com.servidoctor.sdcars.model.Vehiculos">
										...
										<tr style="background: #FFFFFF">
											...
											<td align="center"><IMG border="0" src="<%=request.getContextPath()%>/images/editar.gif" onclick="edit('<bean:write name="vehiculo" property="vehi_cod" scope="page"/>')" width="17"
												height="17" style="cursor: 'hand'" alt="<bean:message key="global.button.editar" />" /> <IMG border="0" src="<%=request.getContextPath()%>/images/eliminar.gif"
