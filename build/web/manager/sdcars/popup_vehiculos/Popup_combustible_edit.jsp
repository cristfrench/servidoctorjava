...
function iniciaFecha(){
   document.forms[0].ano.value=document.forms[0].com_fechaini.value.substring(0,4);
   document.forms[0].mes.value=document.forms[0].com_fechaini.value.substring(5,7);
   document.forms[0].dia.value=document.forms[0].com_fechaini.value.substring(8,10);
   document.forms[0].ano2.value=document.forms[0].com_fechafin.value.substring(0,4);
   document.forms[0].mes2.value=document.forms[0].com_fechafin.value.substring(5,7);
   document.forms[0].dia2.value=document.forms[0].com_fechafin.value.substring(8,10);
  
}

</SCRIPT>

<html:form target="_self" action="/DatosVehiculo/Popup/add_combustible.do">
	<html:hidden property="com_cod"/>
	<html:hidden property="com_veh_cod"/>
						...
						<TBODY>
							...
							<TR>
								<TD class="tdOverNameOption" width="286">
									...
									&nbsp;<%=Integer.parseInt( request.getParameter( "num_combustible" ) ) + 1%></TD>
							...
							<TR>
								...
								<TD>
									<html:text property="com_lecturaini" styleClass="sel" maxlength="6" size="20" onkeyup="isNatural(this);" onblur="isNatural(this);" />
								</TD>
							</TR>
							...
							<TR>
								...
								<td>
									...
									<SCRIPT language="JavaScript">obtenerCamposFechaFuturo('dia2', 'mes2', 'ano2', 'com_fechafin',10);
							    </SCRIPT>
								</td>
							</TR>
							<TR>
								...
								<TD>
									<html:text property="com_lecturafin" styleClass="sel" maxlength="6" size="20" onkeyup="isNatural(this);" onblur="isNatural(this);" />
								</TD>
							</TR>
							<TR>
								<TD class="view_item">
								...
								<TD>
									<html:text property="com_cantidadconsumo" styleClass="sel" maxlength="8" size="20" onkeyup="isFloat(this, 8, 2);" onblur="isFloat(this, 8, 2);" />
								</TD>
							</TR>
							<TR>
								<TD class="view_item">
								...
								<TD>
									<html:text property="com_costocombustible" styleClass="sel" maxlength="10" size="20" onkeyup="isFloat(this, 10, 2);" onblur="isFloat(this, 10, 2);" />
								</TD>
							</TR>
							<TR>
								<TD colspan="2">
