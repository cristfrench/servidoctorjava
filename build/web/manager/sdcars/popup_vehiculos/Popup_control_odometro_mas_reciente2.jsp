...
<SCRIPT>
   ...
   function enviar(dato){
		...
		if (dato=='1'){
			window.opener.llegadaA2(1);
		}
		if (dato=='2'){
			window.opener.llegadaA2(2);
		}
					...
					<tr>
						...
						<bean:message key="5179"/><br><br>
	      				...
	      				<tr>
		      				...
		      				<td class="view_item">&nbsp;<%=request.getParameter( "texto" )%></td>
		      				
		      				<td class="view_item">&nbsp;<%=request.getParameter( "AnteriorFechaControlBD0" )%></td>
		      				<td class="view_item">&nbsp;<%=request.getParameter( "AnteriorDistanciaControlBD0" )%></td>
	      				</tr>
			
	      				</table>
		      			
	      				<br />
	      				<bean:message key="5180"/><br /><br />
	      				<table width="100%" border="1" cellpadding="0" cellspacing="0">
	      				<tr>
	      					<td width="60%">&nbsp;</td>
	      					<td width="20%">&nbsp;<bean:message key="5163"/></td>
	      				...
	      				try{
		      						...
		      						%>
					      				<tr>
						      				...
						      				<td class="view_item">&nbsp;<%=request.getParameter( "FechaOdometroControl" )%></td>
						      				<td class="view_item">&nbsp;<%=request.getParameter( "DistanciaOdometroControl" )%></td>
						      			</tr>
			      				<%	
	      				...
	      				<tr>
		      				...
		      				<td class="view_item">&nbsp;<%=request.getParameter( "texto2" )%></td>
		      				
		      				<td class="view_item">&nbsp;<%=request.getParameter( "DefinitivaFechaControlBD0" )%></td>
		      				<td class="view_item">&nbsp;<%=request.getParameter( "DefinitivaDistanciaControlBD0" )%></td>
	      				</tr>
			
	      				</table>
		      			
	      				<br /><br/><br /><bean:message key="5181"/>
												...
												<td colspan="2">
													<table height="30" cellpadding="0" cellspacing="0" border="0" width="100%">
														...
														<tr align="center" valign="middle">
															<TD colspan="2" align="center">
																<INPUT type="button" onClick="enviar('1')" class="sbttn" value="<bean:message key="5182a"/>">
																<INPUT type="button" onClick="enviar('2')" class="sbttn" value="<bean:message key="5183a"/>">
															</TD>
														</tr>
													</table>
												</td>
