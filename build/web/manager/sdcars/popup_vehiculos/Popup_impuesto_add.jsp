				...
				<table border="0" id="tab2" cellspacing="0" cellpadding="0" width="100%">
					...
					<tr>
						<TD class="tdOverNameOption">
							<bean:message key="3594" />
							&nbsp;
							<%=session.getAttribute( "IMPUESTOS" ) != null && ( ( List ) session.getAttribute( "IMPUESTOS" ) ).size() > 0 ? ( ( List ) session
								.getAttribute( "IMPUESTOS" ) ).size() + 1
								: 1%>
						</TD>
						<TD class="tdOverNameOption">
