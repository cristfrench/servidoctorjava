...
function actualizar()
{
	document.forms[0].action="<%=request.getContextPath()%>/DatosVehiculo/Popup/add_gastos.do"
...
function enviar()
{
	...
	document.forms[0].action="<%=request.getContextPath()%>/DatosVehiculo/Popup/transferir_gastosanuales.do"
...
<html:form target="_self" action="/DatosVehiculo/Popup/add_gastosanuales.do">
	...
	<input type="hidden" name="num_gastosanuales" value="<%=request.getParameter( "num_gastosanuales" )%>" />
	<table border="0" cellpadding="0" cellspacing="0" align="center" width="470">
		<tr>
			<TD>
				<table width="95%" border="0" id="tab2" cellspacing="0" cellpadding="0">
					...
					<tr>
						<TD class="tdOverNameOption" width="286">
							...
							&nbsp;<%=Integer.parseInt( request.getParameter( "num_gastosanuales" ) ) + 1%></TD>
						<TD class="tdOverNameOption">
							<bean:message key="global.button.editar" />
							&nbsp;
							<bean:message key="3524" />
						</TD>
					</tr>
					<TR>
						<TD>
