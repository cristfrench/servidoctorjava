...
<html:form target="_self" action="/DatosVehiculo/Popup/edit_gastos.do">
	<html:hidden property="gasv_cod" />
	<html:hidden property="gasv_veh_cod" />
	<input type="hidden" name="num_gastos" value="<%=request.getParameter( "num_gastos" )%>" />
	<table border="0" cellpadding="0" cellspacing="0" align="center" width="500">
		<tr>
			<TD>
				<table border="0" id="tab2" cellspacing="0" cellpadding="0" width="95%">
					<tr>
						<td colspan="2">
					...
					<tr>
						<TD class="tdOverNameOption">
							Gasto &nbsp;<%=Integer.parseInt( request.getParameter( "num_gastos" ) ) + 1%></TD>
						<TD class="tdOverNameOption">
