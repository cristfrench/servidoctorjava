...
/*   4:    */ import com.servidoctor.parametros.model.Revisiones;
...
/*  26: 23 */     Revisiones revisionS = new Revisiones();
/*  27:    */     try
/*  28:    */     {
...
/*  33:    */       }
/*  34: 31 */       String sql = db.creaSQLSELECT(revisionS);
/*  35: 32 */       pstmt = conn.prepareStatement(sql + " where rev_cod > 0");
/*  36: 33 */       rs = pstmt.executeQuery();
/*  37: 34 */       while (rs.next())
/*  38:    */       {
/*  39: 35 */         Revisiones revision = new Revisiones();
/*  40: 36 */         InicializaData.inicializa(revision.getClass(), revision);
/*  41: 37 */         populate(revision, rs);
/*  42: 38 */         list.add(revision);
/*  43:    */       }
/*  44:    */     }
...
/*  57:    */   }
/*  58:    */   
/*  59:    */   public Revisiones retrive(BigDecimal rev_cod)
/*  60:    */     throws SQLException
/*  61:    */   {
/*  62: 52 */     Revisiones revision = new Revisiones();
/*  63: 53 */     Connection conn = null;
/*  64: 54 */     PreparedStatement pstmt = null;
/*  65: 55 */     ResultSet rs = null;
/*  66: 56 */     Revisiones revisionS = new Revisiones();
/*  67:    */     try
/*  68:    */     {
...
/*  73:    */       }
/*  74: 64 */       String sql = db.creaSQLSELECT(revisionS);
/*  75: 65 */       String where = " where rev_cod=" + rev_cod;
/*  76: 66 */       pstmt = conn.prepareStatement(sql + " " + where);
/*  77: 67 */       rs = pstmt.executeQuery();
/*  78: 68 */       if (rs.next())
/*  79:    */       {
/*  80: 70 */         InicializaData.inicializa(revision.getClass(), revision);
/*  81: 71 */         populate(revision, rs);
/*  82:    */       }
/*  83:    */     }
...
/*  93: 80 */       close(conn);
/*  94:    */     }
/*  95: 82 */     return revision;
/*  96:    */   }
/*  97:    */   
/*  98:    */   public synchronized void insert(Revisiones data)
...
/* 113: 98 */       data.setRev_cod(new BigDecimal(id));
...
/* 130:    */   }
/* 131:    */   
/* 132:    */   public void update(Revisiones data, String[] llaves)
...
/* 160:    */   }
/* 161:    */   
/* 162:    */   public void delete(Revisiones data)
...
/* 171:141 */       String sql = "DELETE FROM sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".revisiones WHERE rev_cod=?";
/* 172:142 */       pstmt = conn.prepareStatement(sql);
/* 173:143 */       pstmt.setBigDecimal(1, data.getRev_cod());
...
/* 195:    */     try
/* 196:    */     {
/* 197:159 */       String sqlid = "Select max(rev_cod) from sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".revisiones";
 ...
 * Qualified Name:     com.servidoctor.parametros.dao.RevisionesDAO
