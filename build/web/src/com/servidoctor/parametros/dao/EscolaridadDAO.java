...
/*   4:    */ import com.servidoctor.parametros.model.Escolaridad;
...
/*  15:    */ 
/*  16:    */ public class EscolaridadDAO
/*  17:    */   extends DAO
/*  18:    */ {
/*  19:    */   public List list()
...
/*  26: 23 */     Escolaridad escolaridadS = new Escolaridad();
/*  27:    */     try
/*  28:    */     {
...
/*  33:    */       }
/*  34: 30 */       String sql = db.creaSQLSELECT(escolaridadS);
/*  35: 31 */       pstmt = conn.prepareStatement(sql);
/*  36: 32 */       rs = pstmt.executeQuery();
/*  37: 33 */       while (rs.next())
/*  38:    */       {
/*  39: 34 */         Escolaridad escolaridad = new Escolaridad();
/*  40: 35 */         InicializaData.inicializa(escolaridad.getClass(), escolaridad);
/*  41: 36 */         populate(escolaridad, rs);
/*  42: 37 */         list.add(escolaridad);
/*  43:    */       }
/*  44: 39 */       close(rs);
/*  45: 40 */       close(pstmt);
/*  46:    */     }
...
/*  59:    */   }
/*  60:    */   
/*  61:    */   public Escolaridad retrive(BigDecimal esco_cod)
/*  62:    */     throws SQLException
/*  63:    */   {
/*  64: 54 */     Escolaridad escolaridad = new Escolaridad();
/*  65: 55 */     Connection conn = null;
/*  66: 56 */     PreparedStatement pstmt = null;
/*  67: 57 */     ResultSet rs = null;
/*  68: 58 */     Escolaridad escolaridadS = new Escolaridad();
/*  69:    */     try
/*  70:    */     {
...
/*  75:    */       }
/*  76: 65 */       String sql = db.creaSQLSELECT(escolaridadS);
/*  77: 66 */       String where = " where esco_cod=" + esco_cod;
/*  78: 67 */       pstmt = conn.prepareStatement(sql + " " + where);
/*  79: 68 */       rs = pstmt.executeQuery();
/*  80: 69 */       if (rs.next())
/*  81:    */       {
/*  82: 71 */         InicializaData.inicializa(escolaridad.getClass(), escolaridad);
/*  83: 72 */         populate(escolaridad, rs);
/*  84:    */       }
/*  85: 75 */       close(rs);
/*  86: 76 */       close(pstmt);
/*  87:    */     }
...
/*  97: 83 */       close(conn);
/*  98:    */     }
/*  99: 85 */     return escolaridad;
/* 100:    */   }
/* 101:    */   
/* 102:    */   public void update(Escolaridad data, String[] llaves)
...
/* 131:    */   }
/* 132:    */   
/* 133:    */   public synchronized void insert(Escolaridad data)
...
/* 150:124 */       data.setEsco_cod(new BigDecimal(id));
...
/* 171:    */   }
/* 172:    */   
/* 173:    */   public void delete(Escolaridad data)
...
/* 182:149 */       String sql = "DELETE FROM sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".escolaridad WHERE esco_cod=?";
/* 183:150 */       pstmt = conn.prepareStatement(sql);
/* 184:151 */       pstmt.setBigDecimal(1, data.getEsco_cod());
...
/* 206:    */     try
/* 207:    */     {
/* 208:168 */       String sqlid = "Select max(esco_cod) from sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".escolaridad ";
 ...
 * Qualified Name:     com.servidoctor.parametros.dao.EscolaridadDAO
