...
/*   4:    */ import com.servidoctor.parametros.model.Odontologia;
...
/*  15:    */ 
/*  16:    */ public class OdontologiaDAO
/*  17:    */   extends DAO
/*  18:    */ {
/*  19:    */   public List list()
...
/*  26: 30 */     Odontologia usuarioOdontologiaS = new Odontologia();
/*  27:    */     try
/*  28:    */     {
...
/*  33:    */       }
/*  34: 37 */       String sql = db.creaSQLSELECT(usuarioOdontologiaS);
/*  35: 38 */       pstmt = conn.prepareStatement(sql + " where odo_cod > 0 order by odo_destratamiento");
/*  36: 39 */       rs = pstmt.executeQuery();
/*  37: 40 */       while (rs.next())
/*  38:    */       {
/*  39: 41 */         Odontologia usuarioOdontologia = new Odontologia();
/*  40: 42 */         InicializaData.inicializa(usuarioOdontologia.getClass(), usuarioOdontologia);
/*  41: 43 */         populate(usuarioOdontologia, rs);
/*  42: 44 */         list.add(usuarioOdontologia);
/*  43:    */       }
/*  44: 46 */       close(rs);
/*  45: 47 */       close(pstmt);
/*  46:    */     }
...
/*  59:    */   }
/*  60:    */   
/*  61:    */   public Odontologia retrive(BigDecimal odo_cod)
/*  62:    */     throws SQLException
/*  63:    */   {
/*  64: 61 */     Odontologia usuarioOdontologia = new Odontologia();
/*  65: 62 */     Connection conn = null;
/*  66: 63 */     PreparedStatement pstmt = null;
/*  67: 64 */     ResultSet rs = null;
/*  68: 65 */     Odontologia usuarioOdontologiaS = new Odontologia();
/*  69:    */     try
/*  70:    */     {
...
/*  75:    */       }
/*  76: 72 */       String sql = db.creaSQLSELECT(usuarioOdontologiaS);
/*  77: 73 */       String where = " where odo_cod=" + odo_cod;
/*  78: 74 */       pstmt = conn.prepareStatement(sql + " " + where);
/*  79: 75 */       rs = pstmt.executeQuery();
/*  80: 76 */       if (rs.next())
/*  81:    */       {
/*  82: 77 */         InicializaData.inicializa(usuarioOdontologia.getClass(), usuarioOdontologia);
/*  83: 78 */         populate(usuarioOdontologia, rs);
/*  84:    */       }
/*  85: 80 */       close(rs);
/*  86: 81 */       close(pstmt);
/*  87:    */     }
...
/*  97: 88 */       close(conn);
/*  98:    */     }
/*  99: 90 */     return usuarioOdontologia;
/* 100:    */   }
/* 101:    */   
/* 102:    */   public synchronized void insert(Odontologia data)
...
/* 119:108 */       data.setOdo_cod(new BigDecimal(id));
...
/* 140:    */   }
/* 141:    */   
/* 142:    */   public void update(Odontologia data, String[] llaves)
...
/* 171:    */   }
/* 172:    */   
/* 173:    */   public void delete(Odontologia data)
...
/* 182:155 */       String sql = "DELETE FROM sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".odontologia WHERE odo_cod=?";
/* 183:156 */       pstmt = conn.prepareStatement(sql);
/* 184:157 */       pstmt.setBigDecimal(1, data.getOdo_cod());
...
/* 206:    */     try
/* 207:    */     {
/* 208:175 */       String sqlid = "Select max(odo_cod) from sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".odontologia";
 ...
 * Qualified Name:     com.servidoctor.parametros.dao.OdontologiaDAO
