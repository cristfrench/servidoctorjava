...
/*   4:    */ import com.servidoctor.parametros.model.RevisionAlternativa;
...
/*  15:    */ 
/*  16:    */ public class RevisionAlternativaDAO
/*  17:    */   extends DAO
/*  18:    */ {
/*  19:    */   public List list()
...
/*  26: 23 */     RevisionAlternativa revisionAlternativaS = new RevisionAlternativa();
/*  27:    */     try
/*  28:    */     {
...
/*  33:    */       }
/*  34: 31 */       String sql = db.creaSQLSELECT(revisionAlternativaS);
/*  35: 32 */       pstmt = conn.prepareStatement(sql + " where ralt_cod > 0");
/*  36: 33 */       rs = pstmt.executeQuery();
/*  37: 34 */       while (rs.next())
/*  38:    */       {
/*  39: 35 */         RevisionAlternativa revisionAlternativa = new RevisionAlternativa();
/*  40: 36 */         InicializaData.inicializa(revisionAlternativa.getClass(), revisionAlternativa);
/*  41: 37 */         populate(revisionAlternativa, rs);
/*  42: 38 */         list.add(revisionAlternativa);
/*  43:    */       }
/*  44: 40 */       close(rs);
/*  45: 41 */       close(pstmt);
/*  46:    */     }
...
/*  59:    */   }
/*  60:    */   
/*  61:    */   public RevisionAlternativa retrive(BigDecimal ralt_cod)
/*  62:    */     throws SQLException
/*  63:    */   {
/*  64: 55 */     RevisionAlternativa revisionAlternativa = new RevisionAlternativa();
/*  65: 56 */     Connection conn = null;
/*  66: 57 */     PreparedStatement pstmt = null;
/*  67: 58 */     ResultSet rs = null;
/*  68: 59 */     RevisionAlternativa revisionAlternativaS = new RevisionAlternativa();
/*  69:    */     try
/*  70:    */     {
...
/*  75:    */       }
/*  76: 66 */       String sql = db.creaSQLSELECT(revisionAlternativaS);
/*  77: 67 */       String where = " where ralt_cod=" + ralt_cod;
/*  78: 68 */       pstmt = conn.prepareStatement(sql + " " + where);
/*  79: 69 */       rs = pstmt.executeQuery();
/*  80: 70 */       if (rs.next())
/*  81:    */       {
/*  82: 72 */         InicializaData.inicializa(revisionAlternativa.getClass(), revisionAlternativa);
/*  83: 73 */         populate(revisionAlternativa, rs);
/*  84:    */       }
/*  85: 76 */       close(rs);
/*  86: 77 */       close(pstmt);
/*  87:    */     }
...
/*  97: 84 */       close(conn);
/*  98:    */     }
/*  99: 86 */     return revisionAlternativa;
/* 100:    */   }
/* 101:    */   
/* 102:    */   public void update(RevisionAlternativa data, String[] llaves)
...
/* 131:    */   }
/* 132:    */   
/* 133:    */   public synchronized void insert(RevisionAlternativa data)
...
/* 150:126 */       data.setRalt_cod(new BigDecimal(id));
...
/* 171:    */   }
/* 172:    */   
/* 173:    */   public void delete(RevisionAlternativa data)
...
/* 182:151 */       String sql = "DELETE FROM sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".revisionalternativa WHERE ralt_cod=?";
/* 183:152 */       pstmt = conn.prepareStatement(sql);
/* 184:153 */       pstmt.setBigDecimal(1, data.getRalt_cod());
...
/* 206:    */     try
/* 207:    */     {
/* 208:170 */       String sqlid = "Select max(ralt_cod) from sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".revisionalternativa ";
 ...
 * Qualified Name:     com.servidoctor.parametros.dao.RevisionAlternativaDAO
