...
/*   4:    */ import com.servidoctor.parametros.model.Forma;
...
/*  33:    */       }
/*  34: 37 */       String sql = db.creaSQLSELECT(formaS);
/*  35: 38 */       pstmt = conn.prepareStatement(sql);
/*  36: 39 */       rs = pstmt.executeQuery();
/*  37: 40 */       while (rs.next())
/*  38:    */       {
/*  39: 41 */         Forma forma = new Forma();
/*  40: 42 */         InicializaData.inicializa(forma.getClass(), forma);
/*  41: 43 */         populate(forma, rs);
/*  42: 44 */         list.add(forma);
/*  43:    */       }
/*  44: 46 */       close(rs);
/*  45: 47 */       close(pstmt);
/*  46:    */     }
...
/*  59:    */   }
/*  60:    */   
/*  61:    */   public Forma retrive(BigDecimal form_cod)
/*  62:    */     throws SQLException
/*  63:    */   {
/*  64: 61 */     Forma forma = new Forma();
/*  65: 62 */     Connection conn = null;
/*  66: 63 */     PreparedStatement pstmt = null;
/*  67: 64 */     ResultSet rs = null;
/*  68: 65 */     Forma formaS = new Forma();
/*  69:    */     try
/*  70:    */     {
...
/*  75:    */       }
/*  76: 72 */       String sql = db.creaSQLSELECT(formaS);
/*  77: 73 */       String where = " where form_cod=" + form_cod;
/*  78: 74 */       pstmt = conn.prepareStatement(sql + " " + where);
/*  79: 75 */       rs = pstmt.executeQuery();
/*  80: 76 */       if (rs.next())
/*  81:    */       {
/*  82: 78 */         InicializaData.inicializa(forma.getClass(), forma);
/*  83: 79 */         populate(forma, rs);
/*  84:    */       }
/*  85: 82 */       close(rs);
/*  86: 83 */       close(pstmt);
/*  87:    */     }
...
/* 100:    */   }
/* 101:    */   
/* 102:    */   public void update(Forma data, String[] llaves)
...
/* 131:    */   }
/* 132:    */   
/* 133:    */   public synchronized void insert(Forma data)
...
/* 150:131 */       data.setForm_cod(new BigDecimal(id));
...
/* 171:    */   }
/* 172:    */   
/* 173:    */   public void delete(Forma data)
...
/* 182:156 */       String sql = "DELETE FROM sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".forma WHERE form_cod=?";
/* 183:157 */       pstmt = conn.prepareStatement(sql);
/* 184:158 */       pstmt.setBigDecimal(1, data.getForm_cod());
...
/* 206:    */     try
/* 207:    */     {
/* 208:175 */       String sqlid = "Select max(form_cod) from sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".forma ";
 ...
 * Qualified Name:     com.servidoctor.parametros.dao.FormaDAO
