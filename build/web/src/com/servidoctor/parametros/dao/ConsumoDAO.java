...
/*   4:    */ import com.servidoctor.parametros.model.Consumo;
...
/*  26: 30 */     Consumo consumoS = new Consumo();
/*  27:    */     try
/*  28:    */     {
...
/*  33:    */       }
/*  34: 37 */       String sql = db.creaSQLSELECT(consumoS);
/*  35: 38 */       pstmt = conn.prepareStatement(sql + " where cons_cod > 0");
/*  36: 39 */       rs = pstmt.executeQuery();
/*  37: 40 */       while (rs.next())
/*  38:    */       {
/*  39: 41 */         Consumo consumo = new Consumo();
/*  40: 42 */         InicializaData.inicializa(consumo.getClass(), consumo);
/*  41: 43 */         populate(consumo, rs);
/*  42: 44 */         list.add(consumo);
/*  43:    */       }
/*  44: 46 */       close(rs);
/*  45: 47 */       close(pstmt);
/*  46:    */     }
...
/*  59:    */   }
/*  60:    */   
/*  61:    */   public Consumo retrive(BigDecimal cons_cod)
/*  62:    */     throws SQLException
/*  63:    */   {
/*  64: 61 */     Consumo consumo = new Consumo();
/*  65: 62 */     Connection conn = null;
/*  66: 63 */     PreparedStatement pstmt = null;
/*  67: 64 */     ResultSet rs = null;
/*  68: 65 */     Consumo consumoS = new Consumo();
/*  69:    */     try
/*  70:    */     {
...
/*  75:    */       }
/*  76: 72 */       String sql = db.creaSQLSELECT(consumoS);
/*  77: 73 */       String where = " where cons_cod=" + cons_cod;
/*  78: 74 */       pstmt = conn.prepareStatement(sql + " " + where);
/*  79: 75 */       rs = pstmt.executeQuery();
/*  80: 76 */       if (rs.next())
/*  81:    */       {
/*  82: 78 */         InicializaData.inicializa(consumo.getClass(), consumo);
/*  83: 79 */         populate(consumo, rs);
/*  84:    */       }
/*  85: 82 */       close(rs);
/*  86: 83 */       close(pstmt);
/*  87:    */     }
...
/*  97: 90 */       close(conn);
/*  98:    */     }
/*  99: 92 */     return consumo;
/* 100:    */   }
/* 101:    */   
/* 102:    */   public void update(Consumo data, String[] llaves)
...
/* 131:    */   }
/* 132:    */   
/* 133:    */   public synchronized void insert(Consumo data)
...
/* 150:131 */       data.setCons_cod(new BigDecimal(id));
...
/* 171:    */   }
/* 172:    */   
/* 173:    */   public void delete(Consumo data)
...
/* 182:156 */       String sql = "DELETE FROM sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".consumo WHERE cons_cod=?";
/* 183:157 */       pstmt = conn.prepareStatement(sql);
/* 184:158 */       pstmt.setBigDecimal(1, data.getCons_cod());
...
/* 206:    */     try
/* 207:    */     {
/* 208:175 */       String sqlid = "Select max(cons_cod) from sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".consumo ";
 ...
 * Qualified Name:     com.servidoctor.parametros.dao.ConsumoDAO
