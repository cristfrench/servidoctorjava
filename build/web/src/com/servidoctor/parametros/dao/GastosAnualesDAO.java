...
/*   4:    */ import com.servidoctor.parametros.model.GastosAnuales;
...
/*  15:    */ 
/*  16:    */ public class GastosAnualesDAO
/*  17:    */   extends DAO
/*  18:    */ {
/*  19:    */   public List list()
...
/*  26: 23 */     GastosAnuales gastoAnualS = new GastosAnuales();
/*  27:    */     try
/*  28:    */     {
...
/*  33:    */       }
/*  34: 31 */       String sql = db.creaSQLSELECT(gastoAnualS);
/*  35: 32 */       pstmt = conn.prepareStatement(sql + " where gas_cod > 0");
/*  36: 33 */       rs = pstmt.executeQuery();
/*  37: 34 */       while (rs.next())
/*  38:    */       {
/*  39: 35 */         GastosAnuales gastoAnual = new GastosAnuales();
/*  40: 36 */         InicializaData.inicializa(gastoAnual.getClass(), gastoAnual);
/*  41: 37 */         populate(gastoAnual, rs);
/*  42: 38 */         list.add(gastoAnual);
/*  43:    */       }
/*  44:    */     }
...
/*  57:    */   }
/*  58:    */   
/*  59:    */   public GastosAnuales retrive(BigDecimal gas_cod)
/*  60:    */     throws SQLException
/*  61:    */   {
/*  62: 52 */     GastosAnuales gastoAnual = new GastosAnuales();
/*  63: 53 */     Connection conn = null;
/*  64: 54 */     PreparedStatement pstmt = null;
/*  65: 55 */     ResultSet rs = null;
/*  66: 56 */     GastosAnuales gastoAnualS = new GastosAnuales();
/*  67:    */     try
/*  68:    */     {
...
/*  73:    */       }
/*  74: 64 */       String sql = db.creaSQLSELECT(gastoAnualS);
/*  75: 65 */       String where = " where gas_cod=" + gas_cod;
/*  76: 66 */       pstmt = conn.prepareStatement(sql + " " + where);
/*  77: 67 */       rs = pstmt.executeQuery();
/*  78: 68 */       if (rs.next())
/*  79:    */       {
/*  80: 70 */         InicializaData.inicializa(gastoAnual.getClass(), gastoAnual);
/*  81: 71 */         populate(gastoAnual, rs);
/*  82:    */       }
/*  83:    */     }
...
/*  93: 80 */       close(conn);
/*  94:    */     }
/*  95: 82 */     return gastoAnual;
/*  96:    */   }
/*  97:    */   
/*  98:    */   public synchronized void insert(GastosAnuales data)
...
/* 130:    */   }
/* 131:    */   
/* 132:    */   public void update(GastosAnuales data, String[] llaves)
...
/* 160:    */   }
/* 161:    */   
/* 162:    */   public void delete(GastosAnuales data)
...
/* 171:141 */       String sql = "DELETE FROM sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".gastosanuales WHERE gas_cod=?";
...
/* 195:    */     try
/* 196:    */     {
/* 197:159 */       String sqlid = "Select max(gas_cod) from sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".gastosanuales";
 ...
 * Qualified Name:     com.servidoctor.parametros.dao.GastosAnualesDAO
