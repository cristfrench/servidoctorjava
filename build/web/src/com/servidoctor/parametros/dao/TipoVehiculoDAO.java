...
/*   4:    */ import com.servidoctor.parametros.model.TipoVehiculo;
...
/*  15:    */ 
/*  16:    */ public class TipoVehiculoDAO
/*  17:    */   extends DAO
/*  18:    */ {
/*  19:    */   public List list()
...
/*  26: 23 */     TipoVehiculo tipoVehiculoS = new TipoVehiculo();
/*  27:    */     try
/*  28:    */     {
...
/*  33:    */       }
/*  34: 30 */       String sql = db.creaSQLSELECT(tipoVehiculoS);
/*  35: 31 */       pstmt = conn.prepareStatement(sql);
/*  36: 32 */       rs = pstmt.executeQuery();
/*  37: 33 */       while (rs.next())
/*  38:    */       {
/*  39: 34 */         TipoVehiculo tipoVehiculo = new TipoVehiculo();
/*  40: 35 */         InicializaData.inicializa(tipoVehiculo.getClass(), tipoVehiculo);
/*  41: 36 */         populate(tipoVehiculo, rs);
/*  42: 37 */         list.add(tipoVehiculo);
/*  43:    */       }
/*  44: 39 */       close(rs);
/*  45: 40 */       close(pstmt);
/*  46:    */     }
...
/*  59:    */   }
/*  60:    */   
/*  61:    */   public TipoVehiculo retrive(BigDecimal tveh_cod)
/*  62:    */     throws SQLException
/*  63:    */   {
/*  64: 54 */     TipoVehiculo tipoVehiculo = new TipoVehiculo();
/*  65: 55 */     Connection conn = null;
/*  66: 56 */     PreparedStatement pstmt = null;
/*  67: 57 */     ResultSet rs = null;
/*  68: 58 */     TipoVehiculo tipoVehiculoS = new TipoVehiculo();
/*  69:    */     try
/*  70:    */     {
...
/*  75:    */       }
/*  76: 65 */       String sql = db.creaSQLSELECT(tipoVehiculoS);
/*  77: 66 */       String where = " where tveh_cod=" + tveh_cod;
/*  78: 67 */       pstmt = conn.prepareStatement(sql + " " + where);
/*  79: 68 */       rs = pstmt.executeQuery();
/*  80: 69 */       if (rs.next())
/*  81:    */       {
/*  82: 71 */         InicializaData.inicializa(tipoVehiculo.getClass(), tipoVehiculo);
/*  83: 72 */         populate(tipoVehiculo, rs);
/*  84:    */       }
/*  85: 75 */       close(rs);
/*  86: 76 */       close(pstmt);
/*  87:    */     }
...
/*  97: 83 */       close(conn);
/*  98:    */     }
/*  99: 85 */     return tipoVehiculo;
/* 100:    */   }
/* 101:    */   
/* 102:    */   public void update(TipoVehiculo data, String[] llaves)
...
/* 131:    */   }
/* 132:    */   
/* 133:    */   public synchronized void insert(TipoVehiculo data)
...
/* 150:125 */       data.setTveh_cod(new BigDecimal(id));
...
/* 171:    */   }
/* 172:    */   
/* 173:    */   public void delete(TipoVehiculo data)
...
/* 182:150 */       String sql = "DELETE FROM sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".tipovehiculo WHERE tveh_cod=?";
/* 183:151 */       pstmt = conn.prepareStatement(sql);
/* 184:152 */       pstmt.setBigDecimal(1, data.getTveh_cod());
...
/* 206:    */     try
/* 207:    */     {
/* 208:169 */       String sqlid = "Select max(tveh_cod) from sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".tipovehiculo ";
 ...
 * Qualified Name:     com.servidoctor.parametros.dao.TipoVehiculoDAO
