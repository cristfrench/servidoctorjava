...
/*   4:    */ import com.servidoctor.parametros.model.EstadoCivil;
...
/*  15:    */ 
/*  16:    */ public class EstadoCivilDAO
/*  17:    */   extends DAO
/*  18:    */ {
/*  19:    */   public List list()
...
/*  26: 23 */     EstadoCivil estadoCivilS = new EstadoCivil();
/*  27:    */     try
/*  28:    */     {
...
/*  33:    */       }
/*  34: 30 */       String sql = db.creaSQLSELECT(estadoCivilS);
/*  35: 31 */       pstmt = conn.prepareStatement(sql + " order by eciv_des");
/*  36: 32 */       rs = pstmt.executeQuery();
/*  37: 33 */       while (rs.next())
/*  38:    */       {
/*  39: 34 */         EstadoCivil estadoCivil = new EstadoCivil();
/*  40: 35 */         InicializaData.inicializa(estadoCivil.getClass(), estadoCivil);
/*  41: 36 */         populate(estadoCivil, rs);
/*  42: 37 */         list.add(estadoCivil);
/*  43:    */       }
/*  44: 39 */       close(rs);
/*  45: 40 */       close(pstmt);
/*  46:    */     }
...
/*  59:    */   }
/*  60:    */   
/*  61:    */   public EstadoCivil retrive(BigDecimal eciv_cod)
/*  62:    */     throws SQLException
/*  63:    */   {
/*  64: 54 */     EstadoCivil estadoCivil = new EstadoCivil();
/*  65: 55 */     Connection conn = null;
/*  66: 56 */     PreparedStatement pstmt = null;
/*  67: 57 */     ResultSet rs = null;
/*  68: 58 */     EstadoCivil estadoCivilS = new EstadoCivil();
/*  69:    */     try
/*  70:    */     {
...
/*  75:    */       }
/*  76: 65 */       String sql = db.creaSQLSELECT(estadoCivilS);
/*  77: 66 */       String where = " where eciv_cod=" + eciv_cod;
/*  78: 67 */       pstmt = conn.prepareStatement(sql + " " + where);
/*  79: 68 */       rs = pstmt.executeQuery();
/*  80: 69 */       if (rs.next())
/*  81:    */       {
/*  82: 71 */         InicializaData.inicializa(estadoCivil.getClass(), estadoCivil);
/*  83: 72 */         populate(estadoCivil, rs);
/*  84:    */       }
/*  85: 75 */       close(rs);
/*  86: 76 */       close(pstmt);
/*  87:    */     }
...
/*  97: 83 */       close(conn);
/*  98:    */     }
/*  99: 85 */     return estadoCivil;
/* 100:    */   }
/* 101:    */   
/* 102:    */   public void update(EstadoCivil data, String[] llaves)
...
/* 131:    */   }
/* 132:    */   
/* 133:    */   public synchronized void insert(EstadoCivil data)
...
/* 150:124 */       data.setEciv_cod(new BigDecimal(id));
...
/* 171:    */   }
/* 172:    */   
/* 173:    */   public void delete(EstadoCivil data)
...
/* 182:149 */       String sql = "DELETE FROM sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".estadocivil WHERE eciv_cod=?";
/* 183:150 */       pstmt = conn.prepareStatement(sql);
/* 184:151 */       pstmt.setBigDecimal(1, data.getEciv_cod());
...
/* 206:    */     try
/* 207:    */     {
/* 208:168 */       String sqlid = "Select max(eciv_cod) from sdoctor" + (this.idioma != null ? "_" + this.idioma : "") + ".estadocivil ";
 ...
 * Qualified Name:     com.servidoctor.parametros.dao.EstadoCivilDAO
