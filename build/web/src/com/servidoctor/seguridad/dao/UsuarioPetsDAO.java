...
/*   4:    */ import com.servidoctor.seguridad.model.UsuarioPets;
...
/*  53:    */   }
/*  54:    */   
/*  55:    */   public UsuarioPets retrive(BigDecimal usup_cod)
/*  56:    */     throws SQLException
/*  57:    */   {
/*  58: 47 */     UsuarioPets usuarioPets = new UsuarioPets();
/*  59: 48 */     Connection conn = null;
/*  60: 49 */     PreparedStatement pstmt = null;
/*  61: 50 */     ResultSet rs = null;
/*  62: 51 */     UsuarioPets usuarioPetsS = new UsuarioPets();
/*  63:    */     try
/*  64:    */     {
/*  65: 53 */       conn = this.ds.getConnection();
/*  66: 54 */       DBUtil db = new DBUtil();
/*  67: 55 */       String sql = db.creaSQLSELECT(usuarioPetsS);
/*  68: 56 */       String where = " where usup_cod = ?";
/*  69: 57 */       pstmt = conn.prepareStatement(sql + where);
/*  70: 58 */       pstmt.setBigDecimal(1, usup_cod);
/*  71: 59 */       rs = pstmt.executeQuery();
/*  72: 60 */       if (rs.next())
/*  73:    */       {
/*  74: 61 */         InicializaData.inicializa(usuarioPets.getClass(), usuarioPets);
/*  75: 62 */         populate(usuarioPets, rs);
/*  76:    */       }
/*  77: 64 */       close(rs);
/*  78: 65 */       close(pstmt);
/*  79:    */     }
...
/*  89: 72 */       close(conn);
/*  90:    */     }
/*  91: 74 */     return usuarioPets;
/*  92:    */   }
/*  93:    */   
/*  94:    */   public UsuarioPets login(String usup_usuario, String usup_clave)
/*  95:    */     throws SQLException
/*  96:    */   {
/*  97: 78 */     UsuarioPets usuarioPets = new UsuarioPets();
/*  98: 79 */     Connection conn = null;
/*  99: 80 */     PreparedStatement pstmt = null;
/* 100: 81 */     ResultSet rs = null;
/* 101: 82 */     UsuarioPets usuarioPetsS = new UsuarioPets();
/* 102:    */     try
/* 103:    */     {
/* 104: 84 */       conn = this.ds.getConnection();
/* 105: 85 */       DBUtil db = new DBUtil();
/* 106: 86 */       String sql = db.creaSQLSELECT(usuarioPetsS);
/* 107: 87 */       String where = " where usup_usuario = ? and usup_clave = ?";
/* 108: 88 */       pstmt = conn.prepareStatement(sql + where);
/* 109: 89 */       pstmt.setString(1, usup_usuario);
/* 110: 90 */       pstmt.setString(2, usup_clave);
/* 111: 91 */       rs = pstmt.executeQuery();
/* 112: 92 */       if (rs.next())
/* 113:    */       {
/* 114: 93 */         InicializaData.inicializa(usuarioPets.getClass(), usuarioPets);
/* 115: 94 */         populate(usuarioPets, rs);
/* 116:    */       }
/* 117: 96 */       close(rs);
/* 118: 97 */       close(pstmt);
/* 119:    */     }
...
/* 129:104 */       close(conn);
/* 130:    */     }
/* 131:106 */     return usuarioPets;
/* 132:    */   }
/* 133:    */   
/* 134:    */   public UsuarioPets login(String usup_usuario)
/* 135:    */     throws SQLException
/* 136:    */   {
/* 137:110 */     UsuarioPets usuarioPets = new UsuarioPets();
/* 138:111 */     Connection conn = null;
/* 139:112 */     PreparedStatement pstmt = null;
/* 140:113 */     ResultSet rs = null;
/* 141:114 */     UsuarioPets usuarioPetsS = new UsuarioPets();
/* 142:    */     try
/* 143:    */     {
/* 144:116 */       conn = this.ds.getConnection();
/* 145:117 */       DBUtil db = new DBUtil();
/* 146:118 */       String sql = db.creaSQLSELECT(usuarioPetsS);
/* 147:119 */       String where = " where usup_usuario = ? ";
/* 148:120 */       pstmt = conn.prepareStatement(sql + where);
/* 149:121 */       pstmt.setString(1, usup_usuario);
/* 150:122 */       rs = pstmt.executeQuery();
/* 151:123 */       if (rs.next())
/* 152:    */       {
/* 153:124 */         InicializaData.inicializa(usuarioPets.getClass(), usuarioPets);
/* 154:125 */         populate(usuarioPets, rs);
/* 155:    */       }
/* 156:127 */       close(rs);
/* 157:128 */       close(pstmt);
/* 158:    */     }
...
/* 168:135 */       close(conn);
/* 169:    */     }
/* 170:137 */     return usuarioPets;
/* 171:    */   }
/* 172:    */   
/* 173:    */   public UsuarioPets loginPassword(String usup_usuario, String usup_password)
/* 174:    */     throws SQLException
/* 175:    */   {
/* 176:142 */     UsuarioPets usuarioPets = new UsuarioPets();
/* 177:143 */     Connection conn = null;
/* 178:144 */     PreparedStatement pstmt = null;
/* 179:145 */     ResultSet rs = null;
/* 180:146 */     UsuarioPets usuarioPetsS = new UsuarioPets();
/* 181:    */     try
/* 182:    */     {
/* 183:148 */       conn = this.ds.getConnection();
/* 184:149 */       DBUtil db = new DBUtil();
/* 185:150 */       String sql = db.creaSQLSELECT(usuarioPetsS);
/* 186:151 */       String where = " where usup_usuario = ? and  usup_clave = ? ";
/* 187:152 */       pstmt = conn.prepareStatement(sql + where);
/* 188:153 */       pstmt.setString(1, usup_usuario);
/* 189:154 */       pstmt.setString(2, usup_password);
/* 190:155 */       rs = pstmt.executeQuery();
/* 191:156 */       if (rs.next())
/* 192:    */       {
/* 193:157 */         InicializaData.inicializa(usuarioPets.getClass(), usuarioPets);
/* 194:158 */         populate(usuarioPets, rs);
/* 195:    */       }
/* 196:160 */       close(rs);
/* 197:161 */       close(pstmt);
/* 198:    */     }
...
/* 208:168 */       close(conn);
/* 209:    */     }
/* 210:170 */     return usuarioPets;
/* 211:    */   }
/* 212:    */   
/* 213:    */   public synchronized void insert(UsuarioPets data)
...
/* 227:184 */       data.setUsup_cod(new BigDecimal(id));
...
/* 247:    */   }
/* 248:    */   
/* 249:    */   public void delete(UsuarioPets data)
...
/* 258:208 */       String sql = "DELETE FROM sdoctor.usuariopets WHERE usup_cod = ?";
/* 259:209 */       pstmt = conn.prepareStatement(sql);
/* 260:210 */       pstmt.setBigDecimal(1, data.getUsup_cod());
...
/* 275:    */   }
/* 276:    */   
/* 277:    */   public void updatePassword(BigDecimal usup_cod, String usuario, String password)
...
/* 282:    */     try
/* 283:    */     {
/* 284:228 */       String sql = "UPDATE sdoctor.usuariopets SET usup_clave = ?, usup_usuario = ? WHERE usup_cod = ?";
...
/* 290:234 */       pstmt.setBigDecimal(3, usup_cod);
...
/* 304:    */   }
/* 305:    */   
/* 306:    */   public void updatePasswordEmergencias(BigDecimal usup_cod, String password)
...
/* 311:    */     try
/* 312:    */     {
/* 313:251 */       String sql = "UPDATE sdoctor.usuariopets SET usup_clave_emer = ? WHERE usup_cod = ?";
...
/* 318:256 */       pstmt.setBigDecimal(2, usup_cod);
...
/* 332:    */   }
/* 333:    */   
/* 334:    */   public UsuarioPets loginEmergencia(String usup_usuario, String usup_clave_emer)
/* 335:    */     throws SQLException
/* 336:    */   {
/* 337:270 */     UsuarioPets usuarioPets = new UsuarioPets();
/* 338:271 */     Connection conn = null;
/* 339:272 */     PreparedStatement pstmt = null;
/* 340:273 */     ResultSet rs = null;
/* 341:274 */     UsuarioPets usuarioPetsS = new UsuarioPets();
/* 342:    */     try
/* 343:    */     {
/* 344:276 */       conn = this.ds.getConnection();
/* 345:277 */       DBUtil db = new DBUtil();
/* 346:278 */       String sql = db.creaSQLSELECT(usuarioPetsS);
/* 347:279 */       String where = " where usup_usuario = ? and usup_clave_emer = ?";
/* 348:280 */       pstmt = conn.prepareStatement(sql + where);
/* 349:281 */       pstmt.setString(1, usup_usuario);
/* 350:282 */       pstmt.setString(2, usup_clave_emer);
/* 351:283 */       rs = pstmt.executeQuery();
/* 352:284 */       if (rs.next())
/* 353:    */       {
/* 354:285 */         InicializaData.inicializa(usuarioPets.getClass(), usuarioPets);
/* 355:286 */         populate(usuarioPets, rs);
/* 356:    */       }
/* 357:288 */       close(rs);
/* 358:289 */       close(pstmt);
/* 359:    */     }
...
/* 379:    */     try
/* 380:    */     {
/* 381:306 */       String sqlid = "Select max(usup_cod) from sdoctor.usuariopets";
...
/* 409:328 */     UsuarioPets usuario = null;
/* 410:329 */     UsuarioPets usuarioS = new UsuarioPets();
...
/* 419:338 */       String where = " where usup_usuario = ?";
...
/* 424:    */       {
/* 425:343 */         usuario = new UsuarioPets();
...
/* 457:368 */       String sql = "update usuariopets set usup_logm_cod = ? where usup_licencia in ( " + string + " ) and usup_licencia in (" + condicionId + ")";
...
/* 486:390 */       String sql = "update usuariopets set usup_artm_cod = ? where usup_licencia in ( " + string + " ) and usup_licencia in (" + condicionId + ")";
...
/* 503:    */   }
/* 504:    */   
/* 505:    */   public int count(String usup_licencia)
...
/* 516:413 */       String sql = db.creaSQLSELECT(new UsuarioPets());
/* 517:414 */       String where = " where usup_licencia = ?";
/* 518:415 */       pstmt = conn.prepareStatement(sql + where);
/* 519:416 */       pstmt.setString(1, usup_licencia);
 ...
 * Qualified Name:     com.servidoctor.seguridad.dao.UsuarioPetsDAO
