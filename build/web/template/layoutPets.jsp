...
<html>
  <head>
    <title><bean:message key="servidoctor.title" /></title>
  ...
  <frameset name="fr" cols="200,*" frameborder="NO" border="0" framespacing="0" rows="*">
    <frameset rows="110',*" frameborder="NO" border="0" framespacing="0">
      <frame name="a0" scrolling="NO" noresize
        src="<%=request.getContextPath()%>/template/a0Pets.htm" marginwidth="0" marginheight="0"
        frameborder="0" border="0">
      <frame name="a1" noresize src="<%=request.getContextPath()%>/template/menuPets.jsp"
        frameborder="0" marginwidth="4" marginheight="0" border="0">
    </frameset>
    <frameset rows="50,*" frameborder="NO" border="0" framespacing="0" cols="*">
      <frame name="a2" noresize src="<%=request.getContextPath()%>/template/a2Pets.jsp"
        frameborder="0" marginwidth="0" marginheight="0" scrolling="NO" border="0">
      <frame name="a3" src="<%=request.getContextPath()%>/template/mainPets.jsp" marginwidth="0"
